              ...
              <div className="testimonial-item wow fadeInUp">
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-content">
                    <p>
                      "The team is amazing! They made me feel comfortable and
                      explained every step. My smile has never looked better."
                    </p>
                  </div>
                </div>
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-content">
                    <p>
                      "I always hated the way my teeth looked in photos, but I
                      was terrified of the dentist. From the moment I walked"
                    </p>
                  </div>
                </div>
                <div className="testimonial-body">
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-content">
                    <p>
                      "Finding a dentist you can trust for the whole family is
                      tough. My daughter was nervous about her first check-up,"
                    </p>
                  </div>
                </div>
                <div className="testimonial-body">
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-content">
                    <p>
                      "needed major dental work after years of neglect — multiple
                      cavities, gum issues, and even missing teeth."
                    </p>
                  </div>
                </div>
                <div className="testimonial-body">
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-content">
                    <p>
                      "I avoided going to the dentist for almost ten years
                      because of bad childhood experiences. When I finally
                      decided"
                    </p>
                  </div>
                </div>
            ...
            <div className="col-xl-4 col-md-6">
              ...
              <div className="testimonial-item wow fadeInUp" data-wow-delay="1s">
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-content">
                    <p>
                      "I was nervous about getting dental implants, but Dr.
                      Webb's team made the whole process so easy and
                      stress-free."
                    </p>
                  </div>
                </div>
              ...
              <div className="why-choose-item-list">
                ...
                <div className="why-choose-item wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <div className="why-choose-item-content">
                    ...
                    <p>
                      We use advanced dental technology to ensure precise, safe,
          ...
          <div className="row section-row">
            <div className="col-lg-12">
              ...
              <div className="section-title section-title-center">
                ...
                <h2 className="text-anime-style-3" data-cursor="-opaque">
                  Personalized dentistry services for every stage of life
                </h2>
              </div>
              {/* Section Title End */}
            </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              ...
              <div className="what-we-do-item wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div className="what-we-do-content">
                  ...
                  <p>
                    We restore damaged or missing teeth with crowns, bridges, and
                    implants, bringing.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="what-we-do-item wow fadeInUp" data-wow-delay="0.6s">
                <div className="what-we-do-image">
                  <figure>
                    <img src="images/what-we-do-image-3.png" alt="" />
                  </figure>
                </div>
                <div className="what-we-do-content">
                ...
                <div className="accordion-item wow fadeInUp">
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        Most patients benefit from a check-up every six months.
                        Regular visits help detect problems early and keep your
